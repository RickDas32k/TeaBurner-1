...
<body>
    ...
    <div class="container-2 single-product">
        <div class="row">
            <div class="col-new">
                <img src="Product/product-23.jpg" width="60%" id="productimg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="Product/product-23.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/product-24.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/decaf-tea.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/decaf-tea2.jpg" width="60%" class="smallimg">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home / Decaf Tea</p>
                <h1>Decaf Vanilla Tea</h1>
                <H4>MRP: 499/-</H4>
                <select>
                    <option>Select Size</option>
                    <option>50gm | 17cups</option>
                    <option>150gm | 51cups</option>
                    <option>250gm | 85cups</option>
                </select>
                <input type="number" value="1">
                <a href="" class="btn">Add To Cart</a>
                <h3>Product Details <i class="fas fa-indent"></i></h3>
                <br>
                <p>A refreshing tisane with the taste of summer fruits & vanilla<br><b>Aroma:</b> Sweet-creamy; marked by notes of vanilla, hins of raisins and wafer-like resonance
                    <br>
                    <b>Appearance:</b> Creamish-white
                </p>
            </div>
        </div>
    </div>
