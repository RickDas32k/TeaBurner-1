...
<body>
    ...
    <div class="container-2 single-product">
        <div class="row">
            <div class="col-new">
                <img src="Product/product-9.jpg" width="60%" id="productimg">
                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="Product/product-9.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/product-10.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/white-tea.jpg" width="60%" class="smallimg">
                    </div>
                    <div class="small-img-col">
                        <img src="Product/white-tea2.jpg" width="60%" class="smallimg">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Home / White Tea</p>
                <h1>Darjeeling Exotic Moonlight White</h1>
                <H4>MRP: 1,499/-</H4>
                <select>
                    <option>Select Size</option>
                    <option>50gm | 20cups</option>
                    <option>150gm | 60cups</option>
                    <option>250gm | 100cups</option>
                </select>
                <input type="number" value="1">
                <a href="" class="btn">Add To Cart</a>
                <h3>Product Details <i class="fas fa-indent"></i></h3>
                <br>
                <p>Immensely fruity with floral shores, fresh from Darjeeling.<br><b>Aroma:</b> Fragrant with lifted notes of fuchsia peony, muskmelon with light citrusy undertones
                    <br>
                    <b>Appearance:</b> Gold
                </p>
            </div>
